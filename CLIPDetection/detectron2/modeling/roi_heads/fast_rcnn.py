...
from CLIPDetection.detectron2.layers import Linear, ShapeSpec, batched_nms, cat, nonzero_tuple
from CLIPDetection.detectron2.modeling.box_regression import Box2BoxTransform
from CLIPDetection.detectron2.structures import Boxes, Instances
