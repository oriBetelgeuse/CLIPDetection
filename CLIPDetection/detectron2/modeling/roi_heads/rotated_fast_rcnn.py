...
from CLIPDetection.detectron2.layers import ShapeSpec, batched_nms_rotated
from CLIPDetection.detectron2.structures import Instances, RotatedBoxes, pairwise_iou_rotated
